...
const heroSliderHero = document.querySelector(".hero-slider-hero");

const heroSliderSpa = document.querySelector(".hero-slider-spa");

if (heroSliderHero) {
  const heroSwiperHero = new Swiper(heroSliderHero, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
...
if (heroSliderSpa) {
  const heroSwiperSpa = new Swiper(heroSliderSpa, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 1,
    ...
    direction: 'horizontal',
    pagination: {
      el: '.hero-slider-pagination-spa',
      clickable: true,
    },
    navigation: {
      nextEl: '.hero-slider-next-spa',
      prevEl: '.hero-slider-prev-spa',
    },
  });
}

const kamesContainer = document.querySelector('.kames__container');

const kamesLink = document.querySelector('.kames__link');

if (kamesContainer && kamesLink) {

  if (document.body.clientWidth < 992) {
    kamesContainer.append(kamesLink);
  }
