...
const sandSlider = document.querySelector(".sand-slider");

if (sandSlider) {
  const sandSwiper = new Swiper(sandSlider, {
    observer: true,
    observeParents: true,
    watchOverflow: true,
    slidesPerView: 'auto',
    ...
    pagination: {
      el: '.sand-slider-pagination',
      clickable: true,
    },
    navigation: {
      nextEl: '.sand-slider-next',
      prevEl: '.sand-slider-prev',
    },
  });
}
// };