...
const reglesItem = document.querySelectorAll('.regles__item');

if (reglesItem) {

  reglesItem.forEach(function (e, i) {
    if (e.querySelector('.regles__num')) {
      e.querySelector('.regles__num').innerHTML = i + 1;
    }
  })
