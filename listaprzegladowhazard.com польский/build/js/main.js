...
const restContainer = document.querySelector('.rest__container');

const restLink = document.querySelector(".rest__link");

if (restContainer && restLink) {
  if (document.body.clientWidth < 992) {
    restContainer.append(restLink);
  }
}
// };