...
const servicesContainerServices = document.querySelector(".services__container_services");

const servicesLinkServices = document.querySelector(".services__link_services");

const servicesContainerPrices = document.querySelector(".services__container_prices");

const servicesLinkPrices = document.querySelector(".services__link_prices");

  
if (servicesContainerServices || servicesContainerPrices) {

  if (servicesLinkServices) {
    if (document.body.clientWidth < 992) {
      servicesContainerServices.append(servicesLinkServices);
    }
  }

  if (servicesLinkPrices) {
    if (document.body.clientWidth < 992) {
      servicesContainerPrices.append(servicesLinkPrices);
    }
  }
